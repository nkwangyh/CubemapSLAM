...
{
public:
    FrameDrawer(Map* pMap,const int &rows,const int &cols,const int &marginH,const int &marginV);
...
protected:
    ...
    std::mutex mMutex;
    //for loging tracking points
    long long int mnTrackedMapPoints;
    long int mnTrackedFrames;
};
