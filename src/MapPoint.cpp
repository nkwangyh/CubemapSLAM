...
//A distinctive descriptor should be the most centered one in the 
//districtor cluster offered by measure from different viewing angle
...
//normal is the viewing direction and depth is the distance
