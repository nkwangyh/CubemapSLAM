...
int LocalMapping::CreateNewMapPoints()
{
    ...
    for(size_t i=0; i<vpNeighKFs.size(); i++)
    {
        ...
        cv::Mat E12 = ComputeE12(mpCurrentKeyFrame,pKF2);

        // Search matches that fullfil epipolar constraint
        vector<pair<size_t,size_t> > vMatchedIndices;
        //ORB bow-based impl
        matcher.SearchForTriangulation(mpCurrentKeyFrame,pKF2,E12,vMatchedIndices);
        ...
        for(int ikp=0; ikp<nmatches; ikp++)
        {
            ...
            // Get bearing vectors
            const cv::Vec3f &kpRay1 = mpCurrentKeyFrame->mvKeyRays[idx1];
            const cv::Vec3f &kpRay2 = pKF2->mvKeyRays[idx2];

            // Check parallax between rays
            const float &rx1 = kpRay1(0), &ry1 = kpRay1(1), &rz1 = kpRay1(2);
            const float &rx2 = kpRay2(0), &ry2 = kpRay2(1), &rz2 = kpRay2(2);
            ...
            float u1, v1;
            CamModelGeneral::GetCamera()->TransformRaysToCubemap(u1, v1, x1, y1, z1);
            ...
            float u2, v2;
            CamModelGeneral::GetCamera()->TransformRaysToCubemap(u2, v2, x2, y2, z2);
...
//K and F don't exist in fisheye camera, using E instead
cv::Mat LocalMapping::ComputeE12(KeyFrame *&pKF1, KeyFrame *&pKF2)
{
